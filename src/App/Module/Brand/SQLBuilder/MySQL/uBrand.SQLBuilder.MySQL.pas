...
begin
  Result :=
    ...
    '   KEY `brand_fk_updated_by_acl_role_id` (`updated_by_acl_user_id`),                                                 '+
    '   CONSTRAINT `brand_fk_created_by_acl_user_id` FOREIGN KEY (`created_by_acl_user_id`) REFERENCES `acl_user` (`id`), '+
    '   CONSTRAINT `brand_fk_updated_by_acl_role_id` FOREIGN KEY (`updated_by_acl_user_id`) REFERENCES `acl_user` (`id`)  '+
    ' )                                                                                                                   ';
end;
