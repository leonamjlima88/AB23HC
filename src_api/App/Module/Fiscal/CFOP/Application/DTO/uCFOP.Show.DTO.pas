...
type
  ...
  public
    ...
    class function FromEntity(ACFOP: TCFOP): TCFOPShowDTO;
  end;
...
class function TCFOPShowDTO.FromEntity(ACFOP: TCFOP): TCFOPShowDTO;
begin
  // Instanciar, retornar DTO e tratar campos diferenciados
  Result                          := TCFOPShowDTO.FromJSON(ACFOP.AsJSON);
  Result.created_by_acl_user_name := ACFOP.created_by_acl_user.name;
  Result.updated_by_acl_user_name := ACFOP.updated_by_acl_user.name;
end;
