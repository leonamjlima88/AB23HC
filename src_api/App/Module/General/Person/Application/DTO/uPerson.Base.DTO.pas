...
uses
  ...
  uPersonContact.Base.DTO;

type
  TPersonBaseDTO = class
  private
    Fname: string;
    ...
    // OneToMany
    Fperson_contact_list: TObjectList<TPersonContactBaseDTO>;
  public
    constructor Create;
    ...
    // OneToMany
    property person_contact_list: TObjectList<TPersonContactBaseDTO> read Fperson_contact_list write Fperson_contact_list;
  end;
...
constructor TPersonBaseDTO.Create;
begin
  Fperson_contact_list := TObjectList<TPersonContactBaseDTO>.Create;
end;

destructor TPersonBaseDTO.Destroy;
begin
