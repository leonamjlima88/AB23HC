inherited BusinessProposalReport: TBusinessProposalReport
  Caption = ''
  PixelsPerInch = 96
  TextHeight = 13
  inherited RLReport1: TRLReport
    DataSource = dtsBusinessProposalItem
  ...
  object dtsBusinessProposal: TDataSource [2]
    Left = 616
    Top = 792
  end
  object dtsBusinessProposalItem: TDataSource [3]
    Left = 736
    Top = 792
  end
