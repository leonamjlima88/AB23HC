...
type
  ...
  public
    ...
    class function FromEntity(ABank: TBank): TBankShowDTO;
  end;
...
class function TBankShowDTO.FromEntity(ABank: TBank): TBankShowDTO;
begin
  // Instanciar, retornar DTO e tratar campos diferenciados
  Result                          := TBankShowDTO.FromJSON(ABank.AsJSON);
  Result.created_by_acl_user_name := ABank.created_by_acl_user.name;
  Result.updated_by_acl_user_name := ABank.updated_by_acl_user.name;
end;
