...
begin
  ...
  // Migration Executada
  lDuration := (GetTickCount - lStartTime)/1300;
  FInformation.Executed(True).Duration(lDuration);
end;

constructor T13CreatePersonTable.Create(AConn: IConnection);
begin
...
class function T13CreatePersonTable.Make(AConn: IConnection): IMigration;
begin
