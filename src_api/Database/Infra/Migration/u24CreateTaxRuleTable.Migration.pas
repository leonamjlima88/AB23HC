...
begin
  ...
  // Migration Executada
  lDuration := (GetTickCount - lStartTime)/2400;
  FInformation.Executed(True).Duration(lDuration);
end;

constructor T24CreateTaxRuleTable.Create(AConn: IConnection);
begin
...
class function T24CreateTaxRuleTable.Make(AConn: IConnection): IMigration;
begin
