...
begin
  ...
  // Migration Executada
  lDuration := (GetTickCount - lStartTime)/2200;
  FInformation.Executed(True).Duration(lDuration);
end;

constructor T22CreateChartOfAccountTable.Create(AConn: IConnection);
begin
...
class function T22CreateChartOfAccountTable.Make(AConn: IConnection): IMigration;
begin
