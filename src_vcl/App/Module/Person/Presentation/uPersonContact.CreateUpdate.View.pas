...
type
  ...
  public
    class function Handle(AState: TEntityState; AMTB: IPersonMemTable): Integer;
  end;
...
class function TPersonContactCreateUpdateView.Handle(AState: TEntityState; AMTB: IPersonMemTable): Integer;
var
