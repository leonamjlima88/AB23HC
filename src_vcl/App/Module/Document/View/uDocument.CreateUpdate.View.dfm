inherited DocumentCreateUpdateView: TDocumentCreateUpdateView
  ClientHeight = 600
  ClientWidth = 600
        ...
        inherited tabMain: TTabSheet
          ...
          inherited pnlMain: TPanel
            ...
            object DBCheckBox1: TDBCheckBox
              ...
              Width = 455
              Height = 17
              Caption = 'Efetuar aprova'#231#227'o do pagamento no ato do lan'#231'amento.'
              DataField = 'is_release_as_completed'
              DataSource = dtsDocument
              TabOrder = 3
              ValueChecked = '1'
              ValueUnchecked = '0'
