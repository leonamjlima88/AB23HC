...
type
  ...
  private
    ...
    procedure RefreshIndexWithoutRequestAPI(AMemTable: IBrandMTB; AEntityState: TEntityState);
...
procedure TBrandIndexView.RefreshIndexWithoutRequestAPI(AMemTable: IBrandMTB; AEntityState: TEntityState);
var
  lKeepGoing: Boolean;
begin
  // Evitar erros
